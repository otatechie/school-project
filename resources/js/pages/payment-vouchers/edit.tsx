...
export default function Edit() {
    const [formData, setFormData] = useState({
        voucher_date: mockVoucher.voucher_date,
        payee_name: mockVoucher.payee_name,
        payee_account_number: mockVoucher.payee_account_number,
        payee_bank: mockVoucher.payee_bank,
        payee_phone: mockVoucher.payee_phone,
        description: mockVoucher.description,
        amount: mockVoucher.amount,
        payment_method: mockVoucher.payment_method,
        cheque_number: mockVoucher.cheque_number,
        payment_reference: mockVoucher.payment_reference,
        budget_line: mockVoucher.budget_line,
        budget_code: mockVoucher.budget_code,
        department_id: mockVoucher.department_id,
    });
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-4 md:p-6">
                ...
                <Card className="max-w-4xl">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update the details for this payment voucher
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {successMessage && (
