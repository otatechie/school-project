                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-sky-500 bg-sky-500 px-5 py-1.5 text-sm leading-normal text-white hover:border-sky-600 hover:bg-sky-600 dark:border-sky-400 dark:bg-sky-400 dark:text-white dark:hover:border-sky-300 dark:hover:bg-sky-300"
                                    >
                                        Deploy now
                                    </a>
                                </li>
